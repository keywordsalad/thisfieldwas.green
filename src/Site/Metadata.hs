...
instance FromJSON PostMetadata where
  parseJSON = withObject "PostMetadata" \pm ->
    PostMetadata
      <$> withScalarOrOneOrMore "contentTemplates" "bare-content" toString pm
      <*> withScalarOrOneOrMore "templates" "skeleton" toString pm
      ...
      <*> withZeroOrMore "tags" toString pm
